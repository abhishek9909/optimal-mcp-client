...
## Reason, Motivation & Novelty:
 - While there is [some stuff on benchmarking MCP](https://github.com/modelscope/MCPBench), it is on the server side of things. The aim of creating a protocol is to make sure the tools are interoperable across LLMs. Understanding what makes a generalizable and optimal client could help save time.
 ...
 - Apart from accuracy, testing for number of tokens generated helps quantify time and energy efficiency of the clients as well. [link 1](https://www.microsoft.com/en-us/research/articles/how-to-evaluate-llms-a-complete-metric-framework/?utm_source=chatgpt.com); [link 2](https://github.com/mlco2/codecarbon)
